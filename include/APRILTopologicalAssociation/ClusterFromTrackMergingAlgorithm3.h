  /// \file ClusterFromTrackMergingAlgorithm3.h
/*
 *
 * ClusterFromTrackMergingAlgorithm3.h header template automatically generated by a class generator
...
#ifndef CLUSTERFROMTRACKMERGINGALGORITHM3_H 
#define CLUSTERFROMTRACKMERGINGALGORITHM3_H
...
/** 
 * @brief ClusterFromTrackMergingAlgorithm3 class
 */ 
class ClusterFromTrackMergingAlgorithm3 : public pandora::Algorithm
{
public:
	/**
...
inline pandora::Algorithm *ClusterFromTrackMergingAlgorithm3::Factory::CreateAlgorithm() const
{
    return new ClusterFromTrackMergingAlgorithm3();
}
