  /// \file ClusterFromTrackMergingAlgorithm2.h
/*
 *
 * ClusterFromTrackMergingAlgorithm2.h header template automatically generated by a class generator
...
#ifndef CLUSTERFROMTRACKMERGINGALGORITHM2_H 
#define CLUSTERFROMTRACKMERGINGALGORITHM2_H
...
/** 
 * @brief ClusterFromTrackMergingAlgorithm2 class
 */ 
class ClusterFromTrackMergingAlgorithm2 : public pandora::Algorithm
{
public:
	/**
...
inline pandora::Algorithm *ClusterFromTrackMergingAlgorithm2::Factory::CreateAlgorithm() const
{
    return new ClusterFromTrackMergingAlgorithm2();
}
