 ...
 *  $Log: $
 */
#ifndef APRIL_RESOLVE_TRACK_ASSOCIATIONS_ALGORITHM_H
#define APRIL_RESOLVE_TRACK_ASSOCIATIONS_ALGORITHM_H 1
...
#endif // #ifndef APRIL_RESOLVE_TRACK_ASSOCIATIONS_ALGORITHM_H