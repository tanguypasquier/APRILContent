  /// \file ArborPseudoLayerPlugin.h
/*
 *
 * ArborPseudoLayerPlugin.h header template automatically generated by a class generator
...
#ifndef ARBORPSEUDOLAYERPLUGIN_H
#define ARBORPSEUDOLAYERPLUGIN_H 1
...
/**
 *  @brief  ArborPseudoLayerPlugin class
 */
class ArborPseudoLayerPlugin : public pandora::PseudoLayerPlugin
{
public:
    /**
     *  @brief  Default constructor
     */
    ArborPseudoLayerPlugin();
...
inline unsigned int ArborPseudoLayerPlugin::GetPseudoLayerAtIp() const
{
