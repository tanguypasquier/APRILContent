/**
 *  @file   ArborShowerProfilePlugin.h
 * 
 *  @brief  Header file for the shower profile plugin class.
 * 
 *  $Log: $
 */
#ifndef ARBOR_SHOWER_PROFILE_PLUGIN_H
#define ARBOR_SHOWER_PROFILE_PLUGIN_H 1
...
{
/**
 *  @brief  ArborShowerProfilePlugin class
 */
class ArborShowerProfilePlugin : public pandora::ShowerProfilePlugin
{
public:
    /**
     *  @brief  Default constructor
     */
    ArborShowerProfilePlugin();
...
inline void ArborShowerProfilePlugin::CalculateTransverseProfile(const pandora::Cluster *const pCluster, const unsigned int maxPseudoLayer, ShowerPeakList &showerPeakList) const
{
...
inline ArborShowerProfilePlugin::ShowerProfileEntry::ShowerProfileEntry() :
    m_isAvailable(true),
    m_energy(0.f),
...
inline ArborShowerProfilePlugin::ShowerPeakObject::ShowerPeakObject(const float energy, const int uBin, const int vBin) :
    m_isAvailable(true),
...
inline float ArborShowerProfilePlugin::ShowerPeakObject::GetPeakEnergy() const
{
    return m_energy;
}
...
inline int ArborShowerProfilePlugin::ShowerPeakObject::GetPeakUBin() const
{
    return m_uBin;
}
...
inline int ArborShowerProfilePlugin::ShowerPeakObject::GetPeakVBin() const
{
    return m_vBin;
}
