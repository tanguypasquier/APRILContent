 ...
 */
#ifndef PERFECTNEUTRALHITRECOVERYALGORITHM_H
#define PERFECTNEUTRALHITRECOVERYALGORITHM_H 1
...
/**
 *  @brief PerfectNeutralHitRecoveryAlgorithm class
 */
class PerfectNeutralHitRecoveryAlgorithm : public pandora::Algorithm
{
public:
    /**
...
inline pandora::Algorithm *PerfectNeutralHitRecoveryAlgorithm::Factory::CreateAlgorithm() const
{
    return new PerfectNeutralHitRecoveryAlgorithm();
}

}

#endif  // PERFECTNEUTRALHITRECOVERYALGORITHM_H
