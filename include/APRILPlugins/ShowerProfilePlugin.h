 ...
 *  $Log: $
 */
#ifndef APRIL_SHOWER_PROFILE_PLUGIN_H
#define APRIL_SHOWER_PROFILE_PLUGIN_H 1
...
{
/**
 *  @brief  APRILShowerProfilePlugin class
 */
class APRILShowerProfilePlugin : public pandora::ShowerProfilePlugin
{
public:
    /**
...
inline void APRILShowerProfilePlugin::CalculateTransverseProfile(const pandora::Cluster *const pCluster, const unsigned int maxPseudoLayer, ShowerPeakList &showerPeakList) const
{
...
inline APRILShowerProfilePlugin::ShowerProfileEntry::ShowerProfileEntry() :
    m_isAvailable(true),
    m_energy(0.f),
...
inline APRILShowerProfilePlugin::ShowerPeakObject::ShowerPeakObject(const float energy, const int uBin, const int vBin) :
    m_isAvailable(true),
...
inline float APRILShowerProfilePlugin::ShowerPeakObject::GetPeakEnergy() const
{
    return m_energy;
}
...
inline int APRILShowerProfilePlugin::ShowerPeakObject::GetPeakUBin() const
{
    return m_uBin;
}
...
inline int APRILShowerProfilePlugin::ShowerPeakObject::GetPeakVBin() const
{
    return m_vBin;
}
