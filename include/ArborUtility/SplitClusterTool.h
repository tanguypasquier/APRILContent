  /// \file SplitClusterTool.h
/*
 *
 * SplitClusterTool.h header template automatically generated by a class generator
...
#ifndef SPLITCLUSTERTOOL_H
#define SPLITCLUSTERTOOL_H
 ...
 */ 
class SplitClusterTool : public pandora::AlgorithmTool
{
public:
    /**
...
inline pandora::AlgorithmTool *SplitClusterTool::Factory::CreateAlgorithmTool() const
{
	return new SplitClusterTool();
}

//------------------------------------------------------------------------------------------------------------------------------------------

inline pandora::StatusCode SplitClusterTool::ReadSettings(const pandora::TiXmlHandle /*xmlHandle*/)
{
