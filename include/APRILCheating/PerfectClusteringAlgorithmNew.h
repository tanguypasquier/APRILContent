/**
 *  @file   APRILContent/include/APRILCheating/PerfectClusteringAlgorithmNew.h
 * 
 ...
 *  $Log: $
 */
#ifndef APRILPERFECTPARTICLEFLOWALGORITHMNEW_H
#define APRILPERFECTPARTICLEFLOWALGORITHMNEW_H 1
...
/**
 *  @brief PerfectClusteringAlgorithmNew class
 */
class PerfectClusteringAlgorithmNew : public pandora::Algorithm
{
public:
    /**
...
inline pandora::Algorithm *PerfectClusteringAlgorithmNew::Factory::CreateAlgorithm() const
{
    return new PerfectClusteringAlgorithmNew();
}

} // namespace april_content

#endif // #ifndef APRILPERFECTPARTICLEFLOWALGORITHMNEW_H
