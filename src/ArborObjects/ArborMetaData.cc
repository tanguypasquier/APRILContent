...
CaloHitMetaData::CaloHitMetaData(const arbor_content::CaloHit *const pCaloHit) :
		m_pCaloHit(pCaloHit),
		m_isLeaf(true),
		m_isSeed(true)
{
...
bool CaloHitMetaData::IsConnected(const arbor_content::CaloHit *const pCaloHit) const
{
...
bool CaloHitMetaData::IsConnected(const arbor_content::CaloHit *const pCaloHit, ConnectorDirection direction) const
{
...
pandora::StatusCode CaloHitMetaData::FindConnector(const arbor_content::CaloHit *const pCaloHit, const Connector *&pConnector) const
{
	pConnector = NULL;
...
pandora::StatusCode CaloHitMetaData::FindConnector(const arbor_content::CaloHit *const pCaloHit, ConnectorDirection direction,
