...
namespace arbor_content
{
  ...
  pandora::StatusCode Branch::BuildFromCaloHit(const CaloHit *const pCaloHit)
  {
    ...
    {
      const ConnectorList &backwardConnectorList(ArborContentApi::GetConnectorList(pCurrentCaloHit, BACKWARD_DIRECTION));
  ...
  pandora::StatusCode Branch::push_back(const CaloHit *const pCaloHit)
  {
    ...
    else
    {
      ...
      if(!ArborContentApi::IsConnected(pCaloHit, pOuterCaloHit, BACKWARD_DIRECTION))
        return pandora::STATUS_CODE_FAILURE;
  ...
  pandora::StatusCode Branch::push_front(const CaloHit *const pCaloHit)
  {
    ...
    else
    {
      ...
      if(!ArborContentApi::IsConnected(pCaloHit, pInnerCaloHit, FORWARD_DIRECTION))
        return pandora::STATUS_CODE_FAILURE;
  ...
  bool Branch::IsValid() const
  {
    ...
    for(const_iterator iter = this->begin(), endIter = this->end() ; endIter != iter ; ++iter)
    {
      ...
      if(!ArborContentApi::IsConnected(pCaloHit, pNextCaloHit, FORWARD_DIRECTION))
        return false;
    }
