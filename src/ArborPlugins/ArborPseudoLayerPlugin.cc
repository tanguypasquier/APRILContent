  /// \file ArborPseudoLayerPlugin.cc
/*
 *
 * ArborPseudoLayerPlugin.cc source template automatically generated by a class generator
...
ArborPseudoLayerPlugin::ArborPseudoLayerPlugin() :
    m_barrelInnerR(0.f),
    m_endCapInnerZ(0.f),
...
float ArborPseudoLayerPlugin::GetMaximumRadius(const AngleVector &angleVector, const float x, const float y) const
{
...
void ArborPseudoLayerPlugin::FillAngleVector(const unsigned int symmetryOrder, const float phi0, AngleVector &angleVector) const
{
