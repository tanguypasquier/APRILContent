...
template pandora::Algorithm *arbor_content::InputObjectListMergingAlgorithm<pandora::CaloHitList>::Factory::CreateAlgorithm() const;
template pandora::Algorithm *arbor_content::InputObjectListMergingAlgorithm<pandora::TrackList>::Factory::CreateAlgorithm() const;
template pandora::Algorithm *arbor_content::InputObjectListMergingAlgorithm<pandora::MCParticleList>::Factory::CreateAlgorithm() const;
template pandora::Algorithm *arbor_content::AlgorithmObjectListMergingAlgorithm<pandora::Cluster>::Factory::CreateAlgorithm() const;
template pandora::Algorithm *arbor_content::AlgorithmObjectListMergingAlgorithm<pandora::Pfo>::Factory::CreateAlgorithm() const;
template pandora::Algorithm *arbor_content::AlgorithmObjectListMergingAlgorithm<pandora::Vertex>::Factory::CreateAlgorithm() const;

template pandora::StatusCode arbor_content::ListMergingAlgorithm<pandora::CaloHitList>::ReadSettings(const pandora::TiXmlHandle xmlHandle);
template pandora::StatusCode arbor_content::ListMergingAlgorithm<pandora::TrackList>::ReadSettings(const pandora::TiXmlHandle xmlHandle);
template pandora::StatusCode arbor_content::ListMergingAlgorithm<pandora::MCParticleList>::ReadSettings(const pandora::TiXmlHandle xmlHandle);
template pandora::StatusCode arbor_content::ListMergingAlgorithm<pandora::Cluster>::ReadSettings(const pandora::TiXmlHandle xmlHandle);
template pandora::StatusCode arbor_content::ListMergingAlgorithm<pandora::Pfo>::ReadSettings(const pandora::TiXmlHandle xmlHandle);
template pandora::StatusCode arbor_content::ListMergingAlgorithm<pandora::Vertex>::ReadSettings(const pandora::TiXmlHandle xmlHandle);
