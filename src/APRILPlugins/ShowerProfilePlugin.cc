...
APRILShowerProfilePlugin::APRILShowerProfilePlugin() :
...
void APRILShowerProfilePlugin::CalculateShowerStartLayer(const Cluster *const pCluster, unsigned int &showerStartLayer) const
{
#if 0
...
void APRILShowerProfilePlugin::CalculateLongitudinalProfile(const Cluster *const pCluster, float &profileStart, float &profileDiscrepancy) const
{
...
void APRILShowerProfilePlugin::CalculateTransverseProfile(const Cluster *const pCluster, const unsigned int maxPseudoLayer, ShowerPeakList &showerPeakList,
    const bool inclusiveMode) const
{
    ...
    std::sort(showerPeakList.begin(), showerPeakList.end(), APRILShowerProfilePlugin::SortShowerPeakListByEnergy);
}

//------------------------------------------------------------------------------------------------------------------------------------------

void APRILShowerProfilePlugin::CalculateTrackBasedTransverseProfile(const Cluster *const pCluster, const unsigned int maxPseudoLayer, const Track *const pMinTrack,
    const TrackVector &trackVector, ShowerPeakList &showerPeakListPhoton, ShowerPeakList &showerPeakListNonPhoton) const
{
    ...
    std::sort(showerPeakListPhoton.begin(), showerPeakListPhoton.end(), APRILShowerProfilePlugin::SortShowerPeakListByEnergy);
    std::sort(showerPeakListNonPhoton.begin(), showerPeakListNonPhoton.end(), APRILShowerProfilePlugin::SortShowerPeakListByEnergy);
}

//------------------------------------------------------------------------------------------------------------------------------------------

void APRILShowerProfilePlugin::CalculateTracklessTransverseShowers(const Cluster *const pCluster, const unsigned int maxPseudoLayer, TwoDShowerProfile &showerProfile,
...
void APRILShowerProfilePlugin::CalculateTrackNearbyTransverseShowers(const Cluster *const pCluster, const unsigned int maxPseudoLayer, const Track *const pMinTrack,
...
void APRILShowerProfilePlugin::CreateEmptyTwoDShowerProfile(TwoDShowerProfile &twoDShowerProfile) const
{
...
void APRILShowerProfilePlugin::InitialiseTransverseProfile(const pandora::Cluster *const pCluster, const unsigned int maxPseudoLayer, TwoDShowerProfile &showerProfile) const
{
...
void APRILShowerProfilePlugin::InitialiseTransverseProfileWithTracks(const pandora::Cluster *const pCluster, const unsigned int maxPseudoLayer, const Track *const pMinTrack,
...
void APRILShowerProfilePlugin::CalculateProjectionAxes(const Cluster *const pCluster, CartesianVector &innerLayerCentroid, CartesianVector &uAxis,
...
void APRILShowerProfilePlugin::InitialiseTwoDShowerProfile(const Cluster *const pCluster, const unsigned int maxPseudoLayer, const CartesianVector &innerLayerCentroid,
...
void APRILShowerProfilePlugin::FindTracksProjection(const Cluster *const pCluster, const TrackVector &trackVector, const CartesianVector &innerLayerCentroid,
...
float APRILShowerProfilePlugin::GetCellLengthScale(const Cluster *const pCluster) const
{
...
void APRILShowerProfilePlugin::MaskLowHeightRegions(TwoDShowerProfile &showerProfile) const
{
...
void APRILShowerProfilePlugin::FindRawPeaksInTwoDShowerProfile(TwoDShowerProfile &showerProfile, ShowerPeakObjectVector &showerPeakObjectVector) const
{
    for (int uBin = 0; uBin < m_transProfileNBins; ++uBin)
    {
        for (int vBin = 0; vBin < m_transProfileNBins; ++vBin)
...
void APRILShowerProfilePlugin::AssociateUnavailableBinsToPeaks(const TwoDShowerProfile &showerProfile, ShowerPeakObjectVector &showerPeakObjectVector) const
{
    for (int uBin = 0; uBin < m_transProfileNBins; ++uBin)
    {
        for (int vBin = 0; vBin < m_transProfileNBins; ++vBin)
...
void APRILShowerProfilePlugin::AssociateBinsToPeaks(const TwoDShowerProfile &showerProfile, ShowerPeakObjectVector &showerPeakObjectVector) const
{
    for (int uBin = 0; uBin < m_transProfileNBins; ++uBin)
    {
        for (int vBin = 0; vBin < m_transProfileNBins; ++vBin)
...
void APRILShowerProfilePlugin::AssociateBinsToPeaks(const TwoDBinVector &twoDBinVector, ShowerPeakObjectVector &showerPeakObjectVector) const
{
...
void APRILShowerProfilePlugin::ApplyQualityCutPeakNBin(ShowerPeakObjectVector &showerPeakObjectVector, TwoDBinVector &twoDBinVector) const
{
...
bool APRILShowerProfilePlugin::PassQualityCutPeakNBin(const ShowerPeakObject &showerPeakObject) const
{
...
void APRILShowerProfilePlugin::MarkPeaksCloseToTracks(const TwoDBinVector &trackProjectionVector, ShowerPeakObjectVector &showerPeakObjectVector) const
{
    for (ShowerPeakObjectVector::iterator iter = showerPeakObjectVector.begin(), iterEnd = showerPeakObjectVector.end(); iter !=iterEnd; ++iter)
    {
        ShowerPeakObject &showerPeakObject(*iter);
...
void APRILShowerProfilePlugin::MatchPeaksInTwoSlices(const ShowerPeakObjectVector &showerPeakObjectVectorFirst, ShowerPeakObjectVector &showerPeakObjectVectorNext) const
{
...
void APRILShowerProfilePlugin::ProcessShowerProfile(TwoDShowerProfile &showerProfile, ShowerPeakObjectVector &showerPeakObjectVector) const
{
...
void APRILShowerProfilePlugin::FindHitPositionProjection(const CartesianVector &hitPosition, const CartesianVector &innerLayerCentroid, const CartesianVector &uAxis,
...
void APRILShowerProfilePlugin::FindBoundaryBins(const int uBin, const int vBin, const int uEdgeLow, const int uEdgeHigh, const int vEdgeLow, const int vEdgeHigh,
...
void APRILShowerProfilePlugin::ConvertBinsToShowerLists(const TwoDShowerProfile &showerProfile, const ShowerPeakObjectVector &showerPeakObjectVector,
...
bool APRILShowerProfilePlugin::IsPeak(TwoDShowerProfile &showerProfile, const int uBin, const int vBin ) const
{
...
bool APRILShowerProfilePlugin::Check8NeighbourFull(TwoDShowerProfile &showerProfile, const int uBin, const int vBin) const
{
...
bool APRILShowerProfilePlugin::Check8NeighbourFast(TwoDShowerProfile &showerProfile, const int uBin, const int vBin) const
{
    for (int uBinStart = uBin - 1, uBinEnd = uBin + 1; uBinStart <= uBinEnd; ++uBinStart)
    {
        for (int vBinStart = vBin - 1, vBinEnd = vBin + 1; vBinStart <= vBinEnd; ++vBinStart)
...
float APRILShowerProfilePlugin::CalculatePeakFindingMetric(const float distance, const float energy) const
{
    ...
    switch (m_transProfilePeakFindingMetric)
    {
        ...
        default:
            std::cout << "APRILShowerProfilePlugin::CalculatePeakFindingMetric invalid parameter for m_transProfilePeakFindingMetric: " << m_transProfilePeakFindingMetric << std::endl;
            throw StatusCodeException(STATUS_CODE_INVALID_PARAMETER);
    }
}
...
void APRILShowerProfilePlugin::CalculateBestPeakUsingMetric(ShowerPeakObjectVector &showerPeakObjectVector, const int uBin, const int vBin,
...
bool APRILShowerProfilePlugin::HasPhotonCandidate(const ShowerPeakObjectVector &showerPeakObjectVector) const
{
    for (ShowerPeakObjectVector::const_iterator iter = showerPeakObjectVector.begin(), iterEnd = showerPeakObjectVector.end(); iter !=iterEnd; ++iter)
    {
        const ShowerPeakObject  &showerPeakObject(*iter);
...
bool APRILShowerProfilePlugin::SortShowerPeakListByEnergy(const ShowerPeak &lhs, const ShowerPeak &rhs)
{
...
StatusCode APRILShowerProfilePlugin::ReadSettings(const TiXmlHandle xmlHandle)
{
