  /// \file NeutralVicinityReclusteringAlgorithm.cc
/*
 *
 * NeutralVicinityReclusteringAlgorithm.cc source template automatically generated by a class generator
...
pandora::StatusCode NeutralVicinityReclusteringAlgorithm::Run()
{
...
pandora::StatusCode NeutralVicinityReclusteringAlgorithm::ReadSettings(const pandora::TiXmlHandle xmlHandle)
{
